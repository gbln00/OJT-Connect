...
<div id="avatar-pending-bar"
    ...
    <svg width="14" height="14" fill="none" stroke="var(--gold-color)" stroke-width="2" viewBox="0 0 24 24">
        <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/>
        <line x1="12" y1="16" x2="12.01" y2="16"/>
    </svg>
    <span style="font-family:'DM Mono',monospace;font-size:11px;color:var(--gold-color);
    ...
    <form id="avatar-upload-form" method="POST"
        ...
        <button type="submit" class="btn btn-sm"
                style="background:var(--gold-color);color:#000;border-color:var(--gold-color);font-size:10px;">
            Save avatar
        </button>
    </form>
