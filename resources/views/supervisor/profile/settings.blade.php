...
<div style="background:var(--surface);border:1px solid var(--border);padding:24px 28px;margin-bottom:20px;
    ...
    <div style="flex:1;min-width:0;">
        ...
        <div style="margin-top:10px;">
            <span class="role-badge supervisor">Company Supervisor</span>
        </div>
    </div>
...
<div id="avatar-pending-bar"
    ...
    <form id="avatar-upload-form" method="POST"
          action="{{ route('supervisor.settings.avatar') }}"
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:start;"
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('supervisor.settings.update.profile') }}"
            ...
            <div>
                ...
                <input type="text" value="Company Supervisor" disabled
    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('supervisor.settings.update.password') }}"
              style="padding:20px;display:flex;flex-direction:column;gap:16px;">
            @csrf @method('PATCH')
    ...
    <div style="padding:20px;display:flex;align-items:center;gap:24px;flex-wrap:wrap;">
        ...
        <div style="flex:1;min-width:200px;">
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                ...
                @if(auth()->user()->avatar)
                <form method="POST" action="{{ route('supervisor.settings.avatar.delete') }}">
                    @csrf @method('DELETE')
                    <button type="submit" class="btn btn-sm"
                            style="background:transparent;color:#c0392b;border-color:rgba(140,14,3,0.3);"
...
<div class="card fade-up fade-up-3"
     style="margin-top:16px;border-color:rgba(140,14,3,0.18);">
    <div class="card-header">
...
function cancelAvatar() {
    document.getElementById('avatar-pending-bar').style.display = 'none';
    pendingFile = null;
    location.reload();
}
