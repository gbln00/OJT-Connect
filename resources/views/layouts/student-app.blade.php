    ...
    <div class="layout-body">
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                ...
                @php
                    $tenantUnread = \App\Models\TenantNotification::forRole('student_intern')->forUser(auth()->id())->unread()->count();
                    $tenantNotifs = \App\Models\TenantNotification::forRole('student_intern')->forUser(auth()->id())->latest()->take(5)->get();
                @endphp
