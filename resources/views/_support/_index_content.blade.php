{{--
    Shared support index content.
    Required variables:
      $tickets   — paginated collection
      $counts    — ['total', 'open', 'resolved']
      $createRoute — route name for new ticket
      $showRoute   — route name for viewing a ticket
--}}
...
<div class="card fade-up fade-up-3">
    ...
    <div style="padding:60px 20px;text-align:center;">
        ...
        <p style="font-family:'DM Mono',monospace;font-size:11px;letter-spacing:0.1em;
                  color:var(--muted);text-transform:uppercase;">No tickets yet</p>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @php $pc = match($ticket->priority) {
                            'urgent' => 'coral', 'high' => 'gold', 'normal' => 'blue', default => 'steel'
                        }; @endphp
