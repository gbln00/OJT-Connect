...
<div style="max-width:700px;margin:0 auto;display:flex;flex-direction:column;gap:12px;">
    ...
    <div class="card fade-up fade-up-1">
        ...
        <form method="POST" action="{{ route('coordinator.accounts.store') }}" style="padding:24px;">
            @csrf
            ...
            <div style="margin-bottom:28px;">
                ...
                <div class="form-hint">// Coordinator and Admin accounts can only be created by the system admin.</div>
                @error('role')<div class="form-error">{{ $message }}</div>@enderror
            </div>

            {{-- Supervisor company picker --}}
