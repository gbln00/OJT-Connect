    ...
    <div style="padding:24px;">
        ...
        <div style="margin-bottom:24px;">
            ...
            <div style="display:flex;gap:10px;margin-top:8px;">
                <a href="{{ route('coordinator.import.template', 'students') }}"
                   class="btn btn-ghost btn-sm">⬇ Student Template</a>
                <a href="{{ route('coordinator.import.template', 'companies') }}"
                   class="btn btn-ghost btn-sm">⬇ Company Template</a>
            </div>
        </div>

        {{-- Upload Form --}}
        <form method="POST" action="{{ route('coordinator.import.store') }}"
