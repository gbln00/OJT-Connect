...
<div style="max-width:640px;margin:0 auto;display:flex;flex-direction:column;gap:12px;">
    ...
    <div class="card fade-up fade-up-1">
        ...
        <form method="POST" action="{{ route('coordinator.companies.store') }}" style="padding:24px;">
            @csrf
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="contact_person" value="{{ old('contact_person') }}"
                       placeholder="Full name of OJT contact"
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;padding-top:4px;">
                ...
                <div style="display:flex;gap:8px;">
                    <a href="{{ route('coordinator.companies.index') }}" class="btn btn-ghost btn-sm">Cancel</a>
